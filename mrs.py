...
# MONGODB CONNECTION
client = MongoClient("mongodb+srv://purviparmar3011:4XcNjtsInhPCnYUN@final-year-project.ddamgnk.mongodb.net/?retryWrites=true&w=majority")
db = client['test']
users_collection = db['users']
music_collection = db['music']
users_df = pd.DataFrame(list(users_collection.find()))
music_df = pd.DataFrame(list(music_collection.find())).drop(columns="_id", axis=1)
